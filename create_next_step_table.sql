-- Manual creation of next_step_comments table
-- Run this in your database if the migration failed
...
CREATE INDEX IF NOT EXISTS "idx_next_step_comments_requirement_id" ON "next_step_comments" ("requirement_id");
CREATE INDEX IF NOT EXISTS "idx_next_step_comments_created_by" ON "next_step_comments" ("created_by");
CREATE INDEX IF NOT EXISTS "idx_next_step_comments_created_at" ON "next_step_comments" ("created_at");
